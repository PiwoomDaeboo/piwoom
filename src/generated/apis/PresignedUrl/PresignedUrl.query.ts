...
/**
 * @description ![file_upload_flow](https://magicube-prod-bucket.s3.amazonaws.com/_static/docs/file_upload_flow.png) * 플로우 1, 2를 input onChange 핸들러에서 실행해야합니다. 1. 미시 서명된 URL 발급 2. 미리 서명된 URL로 파일 업로드 - method: `POST` - url: `url` (1에서 발급받은 url) - form-data: { ...fields, 'Content-Type': '{file.type}/' }
 *
 * @tags presigned_url
...
export const usePresignedUrlCreateMutation = (
  params: MutationHookParams<
    ...
    AxiosError<PresignedErrorMessageType | CommonErrorType>
  >,
) => {
