 ...
 */
export const inquiryApi = new InquiryApi({ instance: instance })
 ...
 * query-keys
 */
export const QUERY_KEY_INQUIRY_API = {
...
export const useInquiryCreateMutation = (
  params: MutationHookParams<
    typeof inquiryApi.inquiryCreate,
    AxiosError<InquiryErrorMessageType | CommonErrorType>
  >,
) => {
  const mutationKey = QUERY_KEY_INQUIRY_API.CREATE()
  return useMutation({
    mutationKey,
    mutationFn: inquiryApi.inquiryCreate,
    ...params?.options,
  })
}
