...
const LoanTermsTable = () => {
  return (
    ...
    >
      {/* 계약 번호 */}
      <Flex borderBottom={'1px solid'} borderColor={'border.basic.2'}>
        <Box
          w={'30%'}
          p={'12px'}
          ...
          borderColor={'border.basic.2'}
        >
          <Text textStyle={'pre-body-6'} color={'grey.10'} fontWeight={'500'}>
            계약 번호
          </Text>
        </Box>
        <Box w={'70%'} p={'12px'}>
      ...
      <Flex borderBottom={'1px solid'} borderColor={'border.basic.2'}>
        ...
        <Box w={'70%'} p={'12px'}>
          <VStack spacing={'8px'} align={'stretch'}>
            {/* 일반 이자율 */}
            <Box>
              <Text textStyle={'pre-body-6'} color={'grey.10'} mb={'4px'}>
                이자율
              </Text>
              <Flex gap={'16px'}>
                <HStack spacing={'8px'}>
      ...
      <Flex borderBottom={'1px solid'} borderColor={'border.basic.2'}>
        ...
        <Box w={'70%'} p={'12px'}>
          <VStack spacing={'4px'} align={'stretch'}>
            <Text textStyle={'pre-body-6'} color={'grey.10'}>
              1. 대출금의 상환 및 이자의 지급은 은행송금(채권자 입금계좌) 방법에
              의한다.
            </Text>
            <Text textStyle={'pre-body-6'} color={'grey.10'}>
      ...
      <Flex borderBottom={'1px solid'} borderColor={'border.basic.2'}>
        ...
        <Box w={'70%'} p={'12px'}>
          <VStack spacing={'4px'} align={'stretch'}>
            ...
            <Text textStyle={'pre-body-6'} color={'grey.10'}>
              • (단, 대부이자, 연체이자, 중도상환수수료 합계금액은 법정최고금리
              연20%를 초과하지 않습니다.)
            </Text>
            <Text textStyle={'pre-body-6'} color={'grey.10'}>
