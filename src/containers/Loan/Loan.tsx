        ...
        >
          ...
          >
            ...
            <Button
              ...
              flexShrink={0}
              variant={'text-secondary'}
              onClick={handleRouteLoanProcedure}
            >
              대출 절차 안내
            </Button>
          </Flex>
        ...
        <Flex flexDir={'column'} w={'100%'}>
          {CARD_DATA.map((card, index) => {
            ...
            return (
              ...
              >
                <HStack mt={'16px'} w={'100%'} justifyContent={'space-between'}>
                  ...
                  <Flex
                    ...
                    alignItems={'center'}
                  >
                    {card?.icon === 'loan1' && <Loan1Icon boxSize={'149px'} />}
                    {card?.icon === 'loan2' && <Loan2Icon boxSize={'149px'} />}
                    {card?.icon === 'loan3' && <Loan3Icon boxSize={'149px'} />}
                  </Flex>
                </HStack>
                <Flex
                ...
                <Flex
                  ...
                  justifyContent={'flex-start'}
                >
                  <HStack gap={'16px'} w={'100%'} justifyContent={'flex-start'}>
                    <Flex
                      justifyContent={'center'}
                      alignItems={'center'}
                      w={'36px'}
