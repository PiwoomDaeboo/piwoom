...
})(window,document,'script','dataLayer','GTM-WQBJW8DZ');
    `,
    }
  }
  googleTagManagerBodyScript() {
    return {
      __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQBJW8DZ"
  ...
  render() {
    return (
      <Html>
        ...
        <body>
          <noscript
            dangerouslySetInnerHTML={this.googleTagManagerBodyScript()}
          />
